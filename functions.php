...
function blog_scripts() {
	...
	wp_enqueue_script( 'blog-jquery', get_template_directory_uri() . '/assets/plugins/jquery-3.3.1.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'blog-popper', get_template_directory_uri() . '/assets/plugins/popper.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'blog-bootstrap', get_template_directory_uri() . '/assets/plugins/bootstrap/js/bootstrap.min.js', array(), _S_VERSION, true );
